    ...
    public partial class Frmsalesmen : Form
    {
        ...
        public void add()
        {
            ...
            try
            {
                ...
                SqlCommand cmd2 = new SqlCommand("select sales_id from sales WHERE sales_id = ( select MAX(sales_id) from sales )", con);
            ...
            SqlCommand cmdd = new SqlCommand("insert into sales_item(sales_id,quantity,item_id,sold_price,user_id)" +
                           "values( " + amt.ToString() + ", " + txtquantity.Text + ","+txtitemid.Text+", " + txtsoldp.Text + "," + adminid + ")", con);
            try
            {
